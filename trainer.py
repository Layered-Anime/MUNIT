...
"""
from networks import AdaINGen, MsImageDis, VAEGen, Stylizer, ContentInjector
...
class MUNIT_Trainer(nn.Module):
    def __init__(self, hyperparameters):
        ...
        self.stylizer = Stylizer(self.style_dim)
        self.content_injector = ContentInjector(hyperparameters['gen']['mlp_dim'], self.style_dim)
        ...
        gen_params = list(self.gen_a.parameters()) + list(self.gen_b.parameters()) + list(self.stylizer.parameters()) + list(self.content_injector.parameters())
    ...
    def gen_update(self, x_a, x_b, hyperparameters):
        ...
        # decode (cross domain)
        x_ba = self.gen_a.decode(c_b, s_a)
        c_a_inject = self.content_injector(c_a, s_b)
        x_ab = self.gen_b.decode(c_a_inject, s_b)
        # encode again
