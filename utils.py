...
from hsj_datautils import PSDPreviewPairDataset
...
def get_hsj_data_loader(conf):
    ...
    dataset = PSDPreviewPairDataset(conf['data_root'], transform=train_transforms, stage=0.4)
